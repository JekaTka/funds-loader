...
It will write to file `final-output.txt`.
`fundprocessor` can write result to any io.Writer
...
generate html: `go tool cover -html=coverage.out`

## Test coverage 96.6%

# Notice

`Missed ID #6928 in original output.txt`. My script returns 1000 records (as in input.txt)
